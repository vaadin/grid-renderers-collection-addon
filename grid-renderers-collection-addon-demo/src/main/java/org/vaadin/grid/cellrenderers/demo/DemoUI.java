...
public class DemoUI extends UI {
	...
	// BeanItemContainer<MyPojo> container = new
	// BeanItemContainer<MyPojo>(MyPojo.class);
	...
	// buttonsLayout.addComponents(normalRangeBtn, minMaxBtn, averageBtn,
	// valueBtn, valueDotBtn, minmaxDotBtn);
	...
	// BeanItemContainer<SimplePojo> container = new
	// BeanItemContainer<SimplePojo>(SimplePojo.class);
	// container.addBean(new SimplePojo(0, "Me", true, new Date(),
	// BigDecimal.valueOf(random.nextDouble() * 100),
	// Double.valueOf(random.nextInt(5))));
	// container.addBean(new SimplePojo(1, "You", false, new Date(),
	// BigDecimal.valueOf(random.nextDouble() * 100),
	// Double.valueOf(random.nextInt(5))));
	// container.addBean(new SimplePojo(2, "He", true, new Date(),
	// BigDecimal.valueOf(random.nextDouble() * 100),
	// Double.valueOf(random.nextInt(5))));
	//
	// Grid grid = new Grid(container);
	...
	protected void init(VaadinRequest request) {
		...
		// tabSheet.addTab(new DateTextDemo(), "DateField and TextField
		// renderers");
