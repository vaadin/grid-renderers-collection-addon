...
/**
 * AbstractHtmlButtonRenderer has the most of the implementation of the {@link HtmlButtonRenderer}
 * but is also used by {@link BrowserOpenerRenderer}
 * 
 * @author Tatu Lund
 */
public abstract class AbstractHtmlButtonRenderer<T> extends ClickableRenderer<T> {
